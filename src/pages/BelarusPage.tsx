  ...
  useJsonLd("belarus", {
    ...
    "@graph": [
      ...
      },
      {
        ...
        description:
          "Испанский, немецкий и английский язык онлайн для жителей Беларуси. Мини-группы до 5 человек и индивидуальные занятия.",
      ...
      <section className="py-24 bg-gradient-to-b from-purple-50/50 to-white">
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-3xl mx-auto space-y-6 text-muted-foreground leading-relaxed">
            ...
            <p>
              Мы обучаем индивидуально и в мини-группах до 5 человек, поэтому каждый ученик из Беларуси
