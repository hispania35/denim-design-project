...
const steps = [
  ...
  { num: "02", title: "Бесплатный урок", text: "Знакомимся с носителем и определяем ваш уровень." },
...
const NativeSpanish = () => {
  useMeta({
    ...
    description:
      "Занятия испанским с носителем языка онлайн и в группе. Живое произношение, разговорная практика с первого урока, мини-группы до 6 человек. Первое занятие бесплатно.",
    canonical: PAGE_URL,
  });
    ...
    "@graph": [
      {
        ...
        description:
          "Занятия испанским языком с преподавателем-носителем: разговорная практика, произношение, мини-группы до 6 человек.",
        provider: {
          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <div className="animate-fade-up text-center lg:text-left">
              ...
              <div className="mt-10 flex flex-wrap gap-x-8 gap-y-4 justify-center lg:justify-start">
                {[
                  { value: "6", label: "человек в группе" },
